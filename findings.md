...
- MySQL template is preserved in `backend/src/main/resources/application.properties`.
- Seed data covers residents, buildings, repair orders, bills, parking vehicles, notices, dashboard revenue trend, dashboard todo list, and system users.
